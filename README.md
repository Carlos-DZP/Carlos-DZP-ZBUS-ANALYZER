...
1. **Clone the repository:**
    ```bash
    git clone [https://github.com/tu-usuario/ZBUS-ANALYZER.git](https://github.com/tu-usuario/ZBUS-ANALYZER.git)
    ```
2. **Set up MATLAB:**
...
If this software contributes to your academic research, papers, or engineering analysis, please cite it as follows:

> Zamora-Pérez, C.D., & Ordaz-Oliver, M.O. (2026). *ZBUS-ANALYZER: An interactive MATLAB-based environment for algorithmic building of the Bus Impedance Matrix in Power Systems*. GitHub repository. https://github.com/tu-usuario/ZBUS-ANALYZER